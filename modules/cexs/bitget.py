...
from config.constants import CEX_WRAPPED_ID, BITGET_NETWORKS_NAME, TOKENS_PER_CHAIN
...
class Bitget(CEX, Logger):
    ...
    async def deposit(self, deposit_data: tuple = None):
        ...
        cex_wallet = get_wallet_for_deposit(self, deposit_network, cex_name='Bitget')
